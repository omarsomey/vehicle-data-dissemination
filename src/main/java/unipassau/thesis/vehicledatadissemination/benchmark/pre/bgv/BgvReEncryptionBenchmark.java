...
import unipassau.thesis.vehicledatadissemination.benchmark.pre.bfv.BfvReEncryptionBenchmark;
...
public class BgvReEncryptionBenchmark {
    ...
    @State(Scope.Thread)
    public static class BGVBenchmarkStateReEncrypt {
    ...
    public void reEncrypt_CC_BGV_128_16384(BGVBenchmarkStateReEncrypt mystate) {
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    public void reEncrypt_CC_BGV_128_32768(BGVBenchmarkStateReEncrypt mystate) {
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    public void reEncrypt_CC_BGV_128_8192(BGVBenchmarkStateReEncrypt mystate) {
    ...
    public static void main(String[] args) throws Exception {
        Options options = new OptionsBuilder()
                .include(BgvReEncryptionBenchmark.class.getSimpleName())
                .build();
