...
public class BfvEncryptionBenchmark {
    ...
    @State(Scope.Thread)
    public static class BFVBenchmarkStateEncryption {
    ...
    public void encrypt_CC_BFV_128_8192(BFVBenchmarkStateEncryption mystate) {
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    public void encrypt_CC_BFV_128_16384(BFVBenchmarkStateEncryption mystate) {
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    public void encrypt_CC_BFV_128_32768(BFVBenchmarkStateEncryption mystate) {
    ...
    @BenchmarkMode(Mode.AverageTime)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    public void encrypt_CC_BFV_128_4096(BFVBenchmarkStateEncryption mystate) {
    ...
    public static void main(String[] args) throws Exception {
        Options options = new OptionsBuilder()
                .include(BfvEncryptionBenchmark.class.getSimpleName())
                .build();
